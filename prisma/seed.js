const { PrismaClient, AdminRole, AdminTitle, KaryaCategory, ContentType, MoodCategory } = require("@prisma/client");
const bcrypt = require("bcryptjs");

const prisma = new PrismaClient();

async function main() {
  console.log("🌱 Starting database seeding for GrowthWithSero on Prisma Postgres...");
  ...
  console.log("✅ Prisma Postgres database seeding completed successfully!");
}
