...
export default function HomePage() {
  ...
  // Strip any accidental emojis from quote
  const cleanQuoteContent = rawQuoteContent.replace(/[\u{1F300}-\u{1FAFF}\u{2600}-\u{27BF}\u{1F600}-\u{1F64F}\u{1F680}-\u{1F6FF}\u{1F900}-\u{1F9FF}]/gu, '').trim();

  return (
    <div className="w-full">
      {/* ========================================================================= */}
      {/* SECTION 1: HERO (PUTIH / LIGHT BACKGROUND - 1 LAYAR PENUH)               */}
      {/* ========================================================================= */}
      <section className="w-full bg-white text-slate-900 min-h-[calc(100vh-72px)] flex items-center justify-center border-b border-slate-200/80 relative py-10 sm:py-16">
        <div className="w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-14 items-center">
            ...
            <div className="lg:col-span-5">
              <div className="p-8 sm:p-10 rounded-3xl bg-purple-50/50 border-2 border-purple-200 shadow-xl relative">
      ...
      {/* ========================================================================= */}
      {/* SECTION 2: TIGA PILAR (UNGU DEEP BACKGROUND - 1 LAYAR PENUH)              */}
      {/* ========================================================================= */}
      <section className="w-full bg-gradient-to-b from-[#4C1D95] via-[#581C87] to-[#3B0764] text-white min-h-screen flex items-center justify-center py-16 sm:py-24 relative">
        <div className="w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      ...
      {/* ========================================================================= */}
      {/* SECTION 3: CHECK-IN MOOD (PUTIH / LIGHT BACKGROUND - 1 LAYAR PENUH)      */}
      {/* ========================================================================= */}
      <section className="w-full bg-slate-50 text-slate-900 min-h-screen flex items-center justify-center py-16 sm:py-24 border-y border-slate-200/80 relative">
        <div className="w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="p-8 sm:p-12 rounded-4xl bg-white border border-slate-200 shadow-xl text-center relative overflow-hidden">
            <div className="relative z-10 space-y-4 max-w-3xl mx-auto">
              <span className="inline-flex items-center gap-1.5 text-xs font-bold px-3.5 py-1.5 rounded-full bg-purple-100 text-purple-800">
              ...
              {/* Mood Feedback (Direct soothing message, NO star rating) */}
              {selectedMood && (
                <div className="pt-6 animate-in fade-in zoom-in-95 duration-200 space-y-4 max-w-2xl mx-auto">
                  <div className="p-5 rounded-2xl bg-purple-50 border border-purple-200 text-purple-900 text-sm sm:text-base font-medium leading-relaxed shadow-xs">
                  ...
                  <div className="pt-2">
                    <a
                      href={user ? "/healing" : "/login?redirect=/healing"}
                      className="inline-flex items-center gap-2 text-xs sm:text-sm font-bold text-purple-700 hover:text-purple-900 hover:underline"
                    >
      ...
      {/* ========================================================================= */}
      {/* SECTION 4: MENGAPA DAILYOFSERO (UNGU DEEP BACKGROUND - 1 LAYAR PENUH)     */}
      {/* ========================================================================= */}
      <section className="w-full bg-gradient-to-b from-[#3B0764] via-[#2E1065] to-[#1E1B4B] text-white min-h-screen flex items-center justify-center py-16 sm:py-24 relative">
        <div className="w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      ...
      {/* ========================================================================= */}
      {/* SECTION 5: CTA (PUTIH / LIGHT BACKGROUND - 1 LAYAR PENUH)                 */}
      {/* ========================================================================= */}
      <section className="w-full bg-white text-slate-900 min-h-screen flex items-center justify-center py-16 sm:py-24">
        <div className="w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
