    ...
    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-14">
      ...
      <div className="p-8 sm:p-10 rounded-4xl bg-white border border-slate-200/90 shadow-sm space-y-8 text-slate-700 text-sm leading-relaxed">
        <section className="space-y-3">
          ...
          <p>
            GrowthWithSero adalah platform berbasis komunitas yang dikembangkan oleh Tim Serotonin sebagai tugas akhir. Layanan mencakup galeri edukasi karya Brand Ambassador, fitur healing/journaling mandiri, dan integrasi informasi ke layanan konseling resmi AwareMind.
          </p>
        </section>
        ...
        <section className="space-y-3">
          ...
          <p>
            Fitur-fitur di GrowthWithSero (termasuk Mood-Star, latihan pernapasan, dan jurnal) dirancang sebagai alat bantu self-care, <strong>bukan pengganti diagnosa klinis, terapi medis, atau penanganan darurat kejiwaan</strong>.
          </p>
          <p>
